    ...
    <section className="space-y-4">
      ...
      <div className="no-scrollbar -mx-4 flex gap-4 overflow-x-auto px-4 pb-1 lg:mx-0 lg:px-0">
        {history.map(({ media }) => (
          <div
            key={media.id}
            className="group w-36 shrink-0 cursor-pointer rounded-2xl bg-surface/70 p-2 transition-all duration-300 hover:bg-surface-2 hover:shadow-xl hover:shadow-black/40"
